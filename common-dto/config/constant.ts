export const CONSTANT_MSG = {
  ...
  ALREADY_PRESENT:
    "Phone number already exists please login using the existing credentials",
  ...
  END_TIME_MISMATCHING:
    "End time is mismatching with respect to doctor session timing",
  ...
  CANCEL_EXCEEDS:
    "Cancellation is not possible; posting date exceeds limit of days for cancellation",
  RESCHED_EXCEEDS:
    "Reschedule is not possible; posting date exceeds limit of days for Reschedule",
  ...
  EMAIL_ALREADY_PRESENT:
    "Email already exists please signup using the existing credentials",
